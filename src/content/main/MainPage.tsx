      ...
      <Grid container spacing={3}>
        <Grid item xs={12} sm={12}>
          <InfoCard
            ...
            imageHeight={250}
            imageTrack="http://vps730378.ovh.net/upfiles/main_o_nas.jpg"
        ...
        <Grid item xs={12} sm={12}>
          <InfoCard
            ...
            imageHeight={250}
            imageTrack="http://vps730378.ovh.net/upfiles/main_oferta.jpg"
        ...
        <Grid item xs={12} sm={12}>
          <InfoCard
            ...
            imageHeight={250}
            imageTrack="http://vps730378.ovh.net/upfiles/main_kontakt.jpg"
